          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-stone-100 text-left">
                ...
                <th className="px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-stone-400">Project</th>
                <th className="px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-stone-400">Status</th>
                <th className="px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-stone-400">Assigned To</th>
              </tr>
            </thead>
            <tbody>
              {tasks.map((task) => (
