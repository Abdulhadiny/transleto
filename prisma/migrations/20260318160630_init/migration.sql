...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('NOT_STARTED', 'IN_PROGRESS', 'SUBMITTED', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "Language" AS ENUM ('EN', 'HA');
...
CREATE TABLE "Project" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT,
    "sourceLang" "Language" NOT NULL DEFAULT 'EN',
    "targetLang" "Language" NOT NULL DEFAULT 'HA',
